...
class MessageWidget extends StatelessWidget {
  const MessageWidget(this.messageKey, this.message, this.sender)
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        Container(
          constraints:
              BoxConstraints(maxWidth: DimensionsCustom.calculateWidth(80)),
          ...
          decoration: BoxDecoration(
              ...
              borderRadius:
                  BorderRadius.circular(DimensionsCustom.calculateWidth(1.5))),
          child: Text(
            message,
